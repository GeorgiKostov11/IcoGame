 ...
 * @author USER
 */
public class Sasho extends Human{
    public Sasho(float x, float y, float z, Camera cam){
        super(x,y,z,cam);
        makeModel();
    }
    ...
    private Cube createHead(float x, float y, float z, float size){
        ...
        Texture sa6o1 = new Texture(IcoRD.textures[1]);
        Texture sa6o2 = new Texture(IcoRD.textures[2]);
        Texture sa6o3 = new Texture(IcoRD.textures[2]);
        Texture sa6o4 = new Texture(IcoRD.textures[3]);
        Texture sa6o5 = new Texture(IcoRD.textures[4]);
    ...
    private Cube createBody(float x, float y, float z, float size){
        ...
        body.setCubeColor(Color.LIGHTGREEN);
    ...
    private Cube createArm(float x, float y, float z, float size){
        ...
        arm.setCubeColor(Color.web("#80DD80"));
