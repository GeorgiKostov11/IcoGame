 ...
 * @author USER
 */
public class Dani extends Human{
    public Dani(float x, float y, float z, Camera cam){
        super(x,y,z,cam);
        makeModel();
    }
    ...
    private Cube createHead(float x, float y, float z, float size){
        ...
        Texture sa6o1 = new Texture(IcoRD.textures[16+1]);//+32
        Texture sa6o2 = new Texture(IcoRD.textures[16+2]);//+32
        Texture sa6o3 = new Texture(IcoRD.textures[16+2]);//+32
        Texture sa6o4 = new Texture(IcoRD.textures[16+3]);//+32
        Texture sa6o5 = new Texture(IcoRD.textures[16+4]);//+32
        sa6o1.rotateLeft(1);
    ...
    private Cube createBody(float x, float y, float z, float size){
        ...
        body.setCubeColor(Color.web("#FFA6A6"));
    ...
    private Cube createArm(float x, float y, float z, float size){
        ...
        arm.setCubeColor(Color.web("#EE9595"));
