 ...
 * @author USER
 */
public class Boci extends Human{
    public Boci(float x, float y, float z, Camera cam){
        super(x,y,z,cam);
        makeModel();
    }
    private void makeModel(){
        ...
        Cube heada=new Cube(x,y-2.5f,z-1,0.5f,super.cam);
        heada.setCubeColor(Color.BLACK);
        //Cube headb=new Cube(x,y-2,z-2,0.5f,super.cam);
        //headb.setCubeColor(Color.BLACK);
        
        cubes.add(heada);
        //cubes.add(headb);
        Cube c = createBody(x,y-0.25f,z,0.75f);
        cubes.add(c);
        //cubes.add(createBody(x,y,z,0.75f));
        cubes.add(createLegs(x,y+1,z,0.75f));
        cubes.add(createLegs(x,y+2.25f,z,0.75f));
        
        Cube armTop1 =createArm(x+1.25f,y+0.5f,z,0.5f);
        Cube armBottom1 = createArm(x+1.25f,y-0.5f,z,0.5f);
        ...
        Cube armTop2 = createArm(x-1.25f,y+0.5f,z,0.5f);
        Cube armBottom2 = createArm(x-1.25f,y-0.5f,z,0.5f);
    ...
    private Cube createHead(float x, float y, float z, float size){
        ...
        Texture sa6o1 = new Texture(IcoRD.textures[4*16+1]);//+32
        Texture sa6o2 = new Texture(IcoRD.textures[4*16+2]);//+32
        Texture sa6o3 = new Texture(IcoRD.textures[4*16+2]);//+32
        Texture sa6o4 = new Texture(IcoRD.textures[4*16+3]);//+32
        Texture sa6o5 = new Texture(IcoRD.textures[4*16+4]);//+32
        sa6o1.rotateLeft(1);
    ...
    private Cube createBody(float x, float y, float z, float size){
        ...
        body.setCubeColor(Color.web("#bf00ff"));
    ...
    private Cube createArm(float x, float y, float z, float size){
        ...
        arm.setCubeColor(Color.web("#af00ef"));
