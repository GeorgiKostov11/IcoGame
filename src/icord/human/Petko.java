 ...
 * @author USER
 */
public class Petko extends Human{
    public Petko(float x, float y, float z, Camera cam){
        super(x,y,z,cam);
        makeModel();
    }
    ...
    private Cube createHead(float x, float y, float z, float size){
        ...
        Texture sa6o1 = new Texture(IcoRD.textures[7]);//6
        Texture sa6o2 = new Texture(IcoRD.textures[8]);//7
        Texture sa6o3 = new Texture(IcoRD.textures[8]);//7
        Texture sa6o4 = new Texture(IcoRD.textures[9]);//7
        Texture sa6o5 = new Texture(IcoRD.textures[10]);//7
        sa6o1.rotateLeft(1);
    ...
    private Cube createBody(float x, float y, float z, float size){
        ...
        body.setCubeColor(Color.web("#323"));
    ...
    private Cube createArm(float x, float y, float z, float size){
        ...
        arm.setCubeColor(Color.web("#212"));
