 ...
 * @author USER
 */
public class Gogo extends Human{
    public Gogo(float x, float y, float z, Camera cam){
        super(x,y,z,cam);
        makeModel();
    }
    private void makeModel(){
        ...
        cubes.add(createHead(x,y-2.75f,z+0.25f,0.75f));        
        cubes.add(createBody(x,y-0.5f,z+0.25f,1.5f));
        cubes.add(createLegs(x,y+2,z,1));
        
        
        Cube armTop1 =createArm(x+1.5f+0.5f,y+0.5f-1,z,0.5f);
        Cube armBottom1 = createArm(x+1.5f+0.5f,y-0.5f-1,z,0.5f);
        ...
        Cube armTop2 = createArm(x-1.5f-0.5f,y+0.5f-1,z,0.5f);
        Cube armBottom2 = createArm(x-1.5f-0.5f,y-0.5f-1,z,0.5f);
    ...
    private Cube createHead(float x, float y, float z, float size){
        ...
        Texture sa6o1 = new Texture(IcoRD.textures[3*16+1]);//+32
        Texture sa6o2 = new Texture(IcoRD.textures[3*16+2]);//+32
        Texture sa6o3 = new Texture(IcoRD.textures[3*16+2]);//+32
        Texture sa6o4 = new Texture(IcoRD.textures[3*16+3]);//+32
        Texture sa6o5 = new Texture(IcoRD.textures[3*16+4]);//+32
        sa6o1.rotateLeft(1);
    ...
    private Cube createBody(float x, float y, float z, float size){
        ...
        body.setCubeColor(Color.web("#ae7"));
    ...
    private Cube createArm(float x, float y, float z, float size){
        ...
        arm.setCubeColor(Color.web("#9d6"));
